...
t_beam				*find_true_beam(
						t_graph *g, t_beam *fake_beam, t_edgepoint start_end);
void				initialize_graph(
						t_graph *g, t_context *context, int directed);
void				insert_edge(t_graph *g, int x, int y, int directed);
void				insert_edge_weight(t_graph *g,
						t_edgepoint *edgepoint, int directed, int weight);
void				initialize_bfs_search(t_graph *g);
void				bfs(t_graph *g, int start);
t_path				*find_path(
						int start, int end, int parents[], t_path **path);
t_beam				*suurballe(
...
void				remove_edge(
						t_graph *g, t_edgepoint edgepoint, int directed);
void				remove_fake_vertex(t_graph *g,
						t_context *context, int vertex, t_path **path);
void				remove_fake_vertexes(
						t_graph *g, t_context *context, t_path **path);
...
void				duplicate_vertex(
						t_graph *g, t_context *context, int vertex);
...
t_beam				*find_optimal_beam(t_graph *g, t_context *context,
						t_beam *beam, t_edgepoint start_end);
...
int					ending_room(int *ending,
						t_context *context, char ***line, t_graph *g);
...
void				add_beam_to_beams(
						t_beams **beams, t_beam **beam, float number_steps);
